...
$(".lax, [data-paroller-factor]").paroller({
    factor: 0.1
});


/*  THANK YOU PAROLLER.JS   */

/*  clipboard copy  */
$('#mail').click(function(){

    var $temp = $("<input>");
    $temp.val('zenithwebdesigns@gmail.com');
    $("body").append($temp);
    $temp.select();
    document.execCommand('copy');
    $temp.remove();
    $('#mail').html('<i class="far fa-envelope"></i>Copied to clipboard!');

    setTimeout(function(){
        $('#mail').html('<i class="far fa-envelope"></i>zenithwebdesigns@gmail.com');
    },1000);
});


/* tel: click desktop message */

$('.desktop-tel').click(function(){
  $(this).html('<i class="fas fa-mobile-alt"></i>Cannot auto-call from this device');
  
  setTimeout(function(){
    $('.desktop-tel').html('<i class="fas fa-mobile-alt"></i>0403 551 943');
  },1000);
});
